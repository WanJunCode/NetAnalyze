...
namespace pcpp
{
	...
	enum OsiModelLayer
	{
		/** Physical layer (layer 1) 物理层*/
		OsiModelPhysicalLayer = 1,
		/** Data link layer (layer 2) 链路层*/
		OsiModelDataLinkLayer = 2,
		/** Network layer (layer 3) 网络层*/
		OsiModelNetworkLayer = 3,
		/** Transport layer (layer 4) 传输层*/
		OsiModelTransportLayer = 4,
		/** Session layer (layer 5) 会话层*/
		OsiModelSesionLayer = 5,
		/** Presentation layer (layer 6) 表示层*/
		OsiModelPresentationLayer = 6,
		/** Application layer (layer 7) 应用层*/
